  ...
  const router = createBrowserRouter(
    createRoutesFromElements(
      [
        ...
        (<Route path={'/skills'} element={<SkillsPage skills={currentSaveFile.value?.skills}/>}></Route>),
        (<Route path={'/inventory'} element={<InventoryPage item_rows={currentSaveFile.value?.items} currentSaveFile={currentSaveFile}/>}></Route>),
        (<Route path={'/unlockables'} element={<UnlockablesPage unlockables={currentSaveFile.value?.unlockable_items}/>}></Route>),
        ...
        (<Route path={'/debug'} element={<DebugPage log_history={currentSaveFile.value?.log_history}/>}></Route>),
