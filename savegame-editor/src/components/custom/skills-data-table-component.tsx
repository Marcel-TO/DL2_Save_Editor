import { SkillItem, Mod } from "@/models/save-models";
import {
  CellContext,
  ColumnDef,
  ColumnFiltersState,
...
export function SkillsDataTableComponent({ skill_section, data }: { skill_section: string, data: SkillItem[] }) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>{skill_section}</CardTitle>
      </CardHeader>
      <CardContent>
