...
export const TypographyH1 = ({
  ...
  return (
    <h1
      className={cn(
        "scroll-m-20 text-4xl font-extrabold tracking-widest lg:text-5xl",
        className,
        fontType === "drip" && "font-drip",
...
export const TypographyH1Thin = ({ text }: { text: string }) => {
  return (
    <h1 className="scroll-m-20 text-4xl tracking-tight lg:text-5xl">{text}</h1>
  );
};
