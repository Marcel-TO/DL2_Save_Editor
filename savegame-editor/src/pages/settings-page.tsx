...
const settingsFormSchema = z.object({
    crcCheckbox: z.boolean(),
    isDebugging: z.boolean(),
    hasAutomaticBackup: z.boolean(),
});
                                    ...
                                    <FormItem>
                                        <Card className="mx-20 my-10">
                                            ...
                                            <CardFooter className="border-t px-6 py-4 transition-all">
                                                <Button
                                                    type="submit"
                                                    className={`transition-all duration-300 ease-in-out ${isSavingCRC
                                    ...
                                    <FormItem>
                                        <Card className="mx-20 my-10">
                                            ...
                                            <CardFooter className="border-t px-6 py-4 transition-all">
                                                <Button
                                                    type="submit"
                                                    className={`transition-all duration-300 ease-in-out ${isSavingDebugging
                                                        ? "rounded-full w-12 h-12"
                                                        : "py-2 px-4 rounded flex items-center justify-center"
                                                        }`}
                                                >
                                    ...
                                    <FormItem>
                                        <Card className="mx-20 my-10">
                                            ...
                                            <CardFooter className="border-t px-6 py-4 transition-all">
                                                <Button
                                                    type="submit"
                                                    className={`transition-all duration-300 ease-in-out ${isSavingAutomaticBackup
                                                        ? "rounded-full w-12 h-12"
                                                        : "py-2 px-4 rounded flex items-center justify-center"
                                                        }`}
                                                >
                            ...
                            <Card className="mx-20 my-10">
                                ...
                                <CardFooter className="border-t px-6 py-4 transition-all">
                                    <Button
                                        ...
                                        className={`transition-all duration-300 ease-in-out ${isSavingDefaultItemLayout
                                            ? "rounded-full w-12 h-12"
                                            : "py-2 px-4 rounded flex items-center justify-center"
                                            }`}
                                    >
                            ...
                            <Card className="mx-20 my-10">
                                ...
                                <CardFooter className="border-t px-6 py-4 transition-all">
                                    <Button
                                        ...
                                        className={`transition-all duration-300 ease-in-out ${isSavingDefaultHeaderFont
                                            ? "rounded-full w-12 h-12"
                                            : "py-2 px-4 rounded flex items-center justify-center"
                                            }`}
                                    >
